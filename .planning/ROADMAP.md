...
Plans:
- [ ] 05-01: Dashboard API endpoints (current-month summary, upcoming dues, overdue list)
- [ ] 05-02: Dashboard UI (summary cards, status tables, upcoming/overdue sections)
